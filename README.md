...
A demo of markdown text, Developed using SwiftUI.
...
1. Clone the repo
   ```sh
   git clone https://github.com/Mobile-Apps-Academy/MarkdownDemoSwiftUi.git
   ```
### Usage

1. How to create the markdown text view
